...
def _load_env_variables(key_file, project_id, dataset_id, base_coors, table_base_coors_wr_kilometriert, table_error, routen_plz, table_view, url_wr, url_dr, error_rate_toleration, batch_size, folder_name, excel_file_name):
...
yaml_config = _load_yaml_config(os.path.join(os.path.dirname(__file__), 'config.yaml'))
